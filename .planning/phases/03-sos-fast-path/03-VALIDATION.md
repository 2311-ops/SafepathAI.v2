...
| T-01 | 03-06 | 4 | SOS-02 (FCM) / NOTIF-03 | T-03-23, T-03-15 | Fan-out reaches every registered device of a recipient (D-32); FCM stays Queued until the device reports receipt | unit | `dotnet test backend/tests/SafePath.Application.Tests --filter FullyQualifiedName~Sos.PushFanOutTests` | ❌ created by 03-06 T1 | ⬜ pending |
| T-02 | 03-06 | 4 | NOTIF-03 (mobile) | T-03-23 | Token registered on sign-in, removed on sign-out; tap routed to responder from all three lifecycles | unit | `flutter test test/features/sos/push_service_test.dart` | ❌ created by 03-06 T2 | ⬜ pending |
| T-03 | 03-06 | 4 | NOTIF-03 (manual) | — | Real FCM push, when tapped, deep-links into SOS responder screen (D-19) | manual-only | N/A — requires real FCM delivery + OS notification tap; gated by 03-06 Task 3 checkpoint | ❌ manual-only, justified | ⬜ pending |
